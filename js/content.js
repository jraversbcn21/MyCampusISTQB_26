...
/* ===================================================
   ...
   =================================================== */
const GLOSSARY = [
  { term: "Testing / Prueba", def: { es: "Conjunto de actividades para descubrir defectos y evaluar la calidad de artefactos de software.", en: "Set of activities to discover defects and evaluate the quality of software artifacts." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.1" },
  { term: "Defecto / Defect", def: { es: "Imperfección en un componente o sistema que puede causar que el componente o sistema falle en realizar su función requerida.", en: "Imperfection in a component or system that can cause it to fail to perform its required function." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.2.3" },
  { term: "Error / Mistake", def: { es: "Acción humana que produce un resultado incorrecto, que introduce un defecto en el sistema.", en: "Human action that produces an incorrect result, introducing a defect into the system." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.2.3" },
  { term: "Fallo / Failure", def: { es: "Evento en el cual un componente o sistema no realiza una función requerida dentro de los límites especificados.", en: "Event in which a component or system does not perform a required function within specified limits." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.2.3" },
  { term: "Causa raíz / Root cause", def: { es: "Razón fundamental por la que ocurre un problema. La eliminación de la causa raíz evita la recurrencia del defecto.", en: "Fundamental reason why a problem occurs. Removing the root cause prevents defect recurrence." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.2.3" },
  { term: "Calidad / Quality", def: { es: "Grado en el que un componente o sistema satisface las necesidades indicadas e implícitas de sus partes interesadas.", en: "Degree to which a component or system satisfies the stated and implied needs of its stakeholders." }, chapter: "1", source: "Syllabus v4.0 keywords §1" },
  { term: "Aseguramiento de la calidad / Quality assurance (QA)", def: { es: "Actividades que se centran en proporcionar confianza en que los requisitos de calidad se cumplirán.", en: "Activities focused on providing confidence that quality requirements will be fulfilled." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.2.2" },
  { term: "Verificación / Verification", def: { es: "Confirmación de que el software cumple con los requisitos especificados.", en: "Confirmation that software meets specified requirements." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.1" },
  { term: "Validación / Validation", def: { es: "Confirmación de que el software satisface las necesidades y expectativas del usuario o cliente.", en: "Confirmation that software satisfies the needs and expectations of the user or customer." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.1" },
  { term: "Producto de prueba / Testware", def: { es: "Artefactos producidos durante el proceso de prueba: planes, casos, scripts, datos, informes.", en: "Artifacts produced during the test process: plans, cases, scripts, data, reports." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.3" },
  { term: "Trazabilidad / Traceability", def: { es: "Capacidad de identificar relaciones entre productos de trabajo de testing y requisitos u otros artefactos.", en: "Ability to identify relationships between test work products and requirements or other artifacts." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.4" },
  { term: "Cobertura / Coverage", def: { es: "Grado, expresado normalmente en porcentaje, en el que un conjunto especificado de elementos o criterios (p. ej. requisitos, código) ha sido ejercitado por un conjunto de pruebas.", en: "The degree, usually expressed as a percentage, to which a specified set of elements or criteria (e.g., requirements, code) has been exercised by a test suite." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.4" },
  ...
  { term: "Análisis de prueba / Test analysis", def: { es: "Actividad del proceso de prueba en la que se analiza la base de prueba para identificar características evaluables y definir las condiciones de prueba, respondiendo a la pregunta «qué probar».", en: "Test process activity in which the test basis is analyzed to identify testable features and define test conditions, answering the question \"what to test\"." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  ...
  { term: "Caso de prueba / Test case", def: { es: "Conjunto de precondiciones, entradas, acciones, resultados esperados y postcondiciones desarrollado a partir de las condiciones de prueba durante el diseño de la prueba.", en: "A set of preconditions, inputs, actions, expected results and postconditions, elaborated from test conditions during test design." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Compleción de la prueba / Test completion", def: { es: "Actividad del proceso de prueba, habitual en los hitos del proyecto, en la que se archiva el testware útil, se cierra el entorno de prueba y se elabora el informe de compleción de la prueba.", en: "Test process activity, typically performed at project milestones, in which useful testware is archived, the test environment is shut down, and a test completion report is produced." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Condición de prueba / Test condition", def: { es: "Elemento o evento identificable de un componente o sistema, como una función o un requisito, que puede verificarse mediante uno o más casos de prueba.", en: "An identifiable element or event of a component or system, such as a function or a requirement, that can be verified by one or more test cases." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Control de la prueba / Test control", def: { es: "Actividad de gestión de la prueba consistente en tomar las acciones necesarias para cumplir los objetivos de prueba, a partir de la información obtenida por la monitorización de la prueba.", en: "Test management activity that involves taking the actions necessary to meet the test objectives, based on information from test monitoring." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Datos de prueba / Test data", def: { es: "Datos que existen, por ejemplo en una base de datos, antes de la ejecución de una prueba y que se usan para, o se ven afectados por, el componente o sistema bajo prueba.", en: "Data that exists, e.g., in a database, before test execution and is used for, or affected by, the component or system under test." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Diseño de la prueba / Test design", def: { es: "Actividad del proceso de prueba en la que las condiciones de prueba se desarrollan en casos de prueba y otro testware, respondiendo a la pregunta «cómo probar».", en: "Test process activity in which test conditions are elaborated into test cases and other testware, answering the question \"how to test\"." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Ejecución de prueba / Test execution", def: { es: "Actividad del proceso de prueba en la que las pruebas se ejecutan conforme a la planificación de ejecución y los resultados reales se comparan con los esperados.", en: "Test process activity in which tests are run according to the test execution schedule and the actual results are compared with the expected results." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Implementación de prueba / Test implementation", def: { es: "Actividad del proceso de prueba en la que se crea o adquiere el testware necesario para la ejecución de la prueba, organizando los casos de prueba en procedimientos de prueba.", en: "Test process activity in which the testware needed for test execution is created or acquired, organizing test cases into test procedures." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Monitorización de la prueba / Test monitoring", def: { es: "Actividad de gestión de la prueba consistente en la comprobación continua de todas las actividades de prueba y la comparación del progreso real con lo planificado.", en: "Test management activity that involves the ongoing checking of all test activities and comparing actual progress against the plan." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Objeto de prueba / Test object", def: { es: "Producto de trabajo (componente, sistema o especificación) que es sometido a testing.", en: "The work product (component, system, or specification) being tested." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.1" },
  { term: "Objetivo de prueba / Test objective", def: { es: "Razón o propósito que guía el diseño y la ejecución de una prueba, como encontrar defectos, generar confianza o evaluar la calidad de un objeto de prueba.", en: "A reason or purpose for designing and executing a test, such as finding defects, gaining confidence, or evaluating the quality of a test object." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.1.1" },
  { term: "Planificación de prueba / Test planning", def: { es: "Actividad del proceso de prueba que consiste en definir los objetivos de prueba y seleccionar el enfoque que mejor los alcanza dentro de las restricciones del contexto.", en: "Test process activity that consists of defining the test objectives and selecting the approach that best achieves them within the constraints of the context." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Procedimiento de prueba / Test procedure", def: { es: "Secuencia de casos de prueba en el orden de ejecución, junto con las acciones asociadas necesarias para llevarlos a cabo.", en: "A sequence of test cases in execution order, together with the associated actions required to carry them out." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Proceso de prueba / Test process", def: { es: "Conjunto de actividades de prueba (planificación, monitorización, control, análisis, diseño, implementación, ejecución y compleción) organizadas para alcanzar los objetivos de prueba, adaptable al contexto del proyecto.", en: "The set of test activities (planning, monitoring, control, analysis, design, implementation, execution and completion) organized to achieve the test objectives, tailored to the project context." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4" },
  { term: "Resultado de prueba / Test result", def: { es: "Indicación, obtenida al ejecutar una prueba, de si el software se comportó o no como se esperaba en una prueba específica.", en: "An indication, obtained from executing a test, of whether or not the software behaved as expected for a specific test." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.4.1" },
  { term: "Prueba de componentes / Component testing", def: { es: "Nivel de prueba que verifica componentes individuales del software en aislamiento.", en: "Test level that verifies individual software components in isolation." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.1" },
  { term: "Prueba de integración / Integration testing", def: { es: "Nivel de prueba que verifica la interacción entre componentes o sistemas integrados.", en: "Test level that verifies the interaction between integrated components or systems." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.1" },
  { term: "Prueba de sistema / System testing", def: { es: "Nivel de prueba que verifica el comportamiento del sistema completo de extremo a extremo.", en: "Test level that verifies the behavior of the complete system end-to-end." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.1" },
  { term: "Prueba de aceptación / Acceptance testing", def: { es: "Nivel de prueba realizado para determinar si el sistema cumple con los criterios de aceptación del negocio.", en: "Test level performed to determine if the system meets business acceptance criteria." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.1" },
  { term: "Prueba funcional / Functional testing", def: { es: "Pruebas que verifican lo que el sistema HACE, basadas en las funciones requeridas.", en: "Tests that verify what the system DOES, based on required functions." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.2" },
  { term: "Prueba no funcional / Non-functional testing", def: { es: "Pruebas que verifican cómo se comporta el sistema (rendimiento, usabilidad, seguridad, fiabilidad).", en: "Tests that verify how the system behaves (performance, usability, security, reliability)." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.2" },
  { term: "Prueba de regresión / Regression testing", def: { es: "Pruebas que verifican que los cambios no han introducido nuevos defectos en áreas que funcionaban correctamente.", en: "Tests that verify changes haven't introduced new defects in areas that previously worked correctly." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.3" },
  { term: "Testing de humo / Smoke test", def: { es: "Conjunto básico de pruebas que verifican las funcionalidades más críticas para confirmar que el sistema puede ser probado más a fondo.", en: "Basic set of tests verifying the most critical functionalities to confirm the system can be further tested." }, chapter: "2", source: "Syllabus v4.0 §5.1.3 (ejemplo de criterio de entrada: 'initial quality level of a test object, e.g., all smoke tests have passed')" },
  { term: "Prueba alfa / Alpha testing", def: { es: "Prueba de aceptación realizada por usuarios en el sitio del desarrollador.", en: "Acceptance testing performed by users at the developer's site." }, chapter: "2", source: "Syllabus v4.0 §2.2.1" },
  { term: "Prueba beta / Beta testing", def: { es: "Prueba de aceptación realizada por usuarios en su propio entorno antes del lanzamiento general.", en: "Acceptance testing performed by users in their own environment before general release." }, chapter: "2", source: "Syllabus v4.0 §2.2.1" },
  { term: "Nivel de prueba / Test level", def: { es: "Grupo de actividades de prueba organizadas y gestionadas en conjunto, correspondiente a una instancia del proceso de prueba realizada sobre el software en una fase de desarrollo dada (de componentes individuales a sistemas completos).", en: "A group of test activities that are organized and managed together, corresponding to an instance of the test process performed in relation to software at a given phase of development, from individual components to complete systems." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2" },
  { term: "Tipo de prueba / Test type", def: { es: "Grupo de actividades de prueba relacionadas con características de calidad específicas (p. ej. funcionalidad, caja blanca, caja negra), que pueden realizarse en cualquier nivel de prueba.", en: "A group of test activities related to specific quality characteristics (e.g., functional, white-box, black-box), most of which can be performed at any test level." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2" },
  { term: "Prueba de integración de componentes / Component integration testing", def: { es: "Nivel de prueba centrado en las interfaces e interacciones entre componentes, muy dependiente de la estrategia de integración (bottom-up, top-down o big-bang).", en: "Test level focused on the interfaces and interactions between components, heavily dependent on the integration strategy (bottom-up, top-down or big-bang)." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.1" },
  { term: "Prueba de integración de sistemas / System integration testing", def: { es: "Nivel de prueba centrado en las interfaces del sistema bajo prueba con otros sistemas y servicios externos, que requiere entornos de prueba similares al operacional.", en: "Test level focused on the interfaces of the system under test with other systems and external services, requiring test environments similar to the operational one." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.1" },
  { term: "Prueba de caja negra / Black-box testing", def: { es: "Tipo de prueba basado en especificaciones, que deriva los casos de prueba de la documentación sin considerar la estructura interna del objeto de prueba.", en: "Specification-based test type that derives tests from documentation, without considering the internal structure of the test object." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.2" },
  { term: "Prueba de caja blanca / White-box testing", def: { es: "Tipo de prueba basado en la estructura, que deriva los casos de prueba de la implementación o estructura interna del sistema (código, arquitectura, flujos de trabajo o de datos).", en: "Structure-based test type that derives tests from the implementation or internal structure of the system (code, architecture, work flows and data flows)." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.2" },
  { term: "Prueba de confirmación / Confirmation testing", def: { es: "Tipo de prueba dinámica realizada tras corregir un defecto, para comprobar que la corrección lo ha resuelto; idealmente la realiza la misma persona que ejecutó la prueba original.", en: "Dynamic test type performed after a defect is fixed, to check whether the fix resolved the problem; ideally performed by the same person who ran the original test." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.2.3" },
  { term: "Prueba de mantenimiento / Maintenance testing", def: { es: "Prueba de un sistema operacional ya desplegado, motivada por modificaciones, migraciones o el retiro del sistema, que evalúa tanto el cambio realizado como posibles regresiones en el resto del sistema.", en: "Testing of an already-deployed operational system, triggered by modifications, upgrades/migrations or retirement, evaluating both the change made and possible regressions in the rest of the system." }, chapter: "2", source: "Syllabus v4.0 keywords §2 · §2.3" },
  { term: "Revisión / Review", def: { es: "Proceso estático que evalúa los productos de trabajo de software para encontrar defectos antes de la ejecución.", en: "Static process evaluating software work products to find defects before execution." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.2" },
  { term: "Inspección / Inspection", def: { es: "Tipo más formal de revisión estática, con roles definidos, métricas y criterios de entrada/salida.", en: "Most formal type of static review, with defined roles, metrics and entry/exit criteria." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.2.4" },
  { term: "Revisión guiada / Walkthrough", def: { es: "Tipo de revisión guiada por el autor, donde el equipo sigue la lógica del producto paso a paso.", en: "Review type guided by the author, where the team follows the product logic step by step." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.2.4" },
  { term: "Análisis estático / Static analysis", def: { es: "Evaluación automatizada del código sin ejecutarlo, para detectar defectos de código y violaciones de estándares.", en: "Automated evaluation of code without executing it, to detect code defects and standard violations." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.1" },
  { term: "Prueba estática / Static testing", def: { es: "Testing que no implica la ejecución del software; incluye las revisiones y el análisis estático, y permite encontrar defectos directamente en el producto de trabajo.", en: "Testing that does not involve the execution of software; it includes reviews and static analysis, and can directly find defects in the work product." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.1.3" },
  { term: "Prueba dinámica / Dynamic testing", def: { es: "Testing que implica la ejecución del software, a diferencia de la prueba estática, y que provoca fallos para encontrar defectos.", en: "Testing that involves the execution of software, as opposed to static testing, causing failures in order to find defects." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.1.3" },
  ...
  { term: "Revisión informal / Informal review", def: { es: "Tipo de revisión que no sigue un proceso definido ni requiere una salida documentada formal; su objetivo principal es detectar anomalías.", en: "Review type that does not follow a defined process and does not require formal documented output; its main objective is detecting anomalies." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.2.4" },
  { term: "Revisión formal / Formal review", def: { es: "Revisión que sigue un proceso definido y documentado, con roles, criterios de entrada/salida y métricas; la inspección es el tipo más formal.", en: "Review that follows a defined and documented process, with roles, entry/exit criteria and metrics; inspection is the most formal type." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.2" },
  { term: "Revisión técnica / Technical review", def: { es: "Revisión realizada por revisores técnicamente cualificados y liderada por un moderador, cuyos objetivos son alcanzar consenso y tomar decisiones sobre un problema técnico, además de detectar anomalías.", en: "Review performed by technically qualified reviewers and led by a moderator, whose objectives are to gain consensus and make decisions on a technical problem, as well as detecting anomalies." }, chapter: "3", source: "Syllabus v4.0 keywords §3 · §3.2.4" },
  { term: "Partición de equivalencia / Equivalence partitioning (EP)", def: { es: "Técnica de caja negra que divide las entradas en particiones donde todos los valores se comportan igual.", en: "Black-box technique dividing inputs into partitions where all values behave the same." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.2.1" },
  { term: "Análisis del valor frontera / Boundary value analysis (BVA)", def: { es: "Técnica de caja negra que prueba los valores en los bordes de las particiones de equivalencia.", en: "Black-box technique testing values at the edges of equivalence partitions." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.2.2" },
  { term: "Prueba de tabla de decisión / Decision table testing", def: { es: "Técnica de caja negra para probar combinaciones de condiciones lógicas y sus acciones resultantes.", en: "Black-box technique for testing combinations of logical conditions and their resulting actions." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.2.3" },
  { term: "Prueba de transición de estado / State transition testing", def: { es: "Técnica de caja negra para probar sistemas cuyo comportamiento depende del estado actual y del evento recibido.", en: "Black-box technique for testing systems whose behavior depends on the current state and received event." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.2.4" },
  { term: "Cobertura de sentencia / Statement coverage", def: { es: "Técnica de caja blanca que mide el porcentaje de sentencias ejecutables ejecutadas por los tests.", en: "White-box technique measuring the percentage of executable statements executed by tests." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.3.1" },
  { term: "Cobertura de rama / Branch coverage", def: { es: "Técnica de caja blanca que mide el porcentaje de ramas del flujo de control ejecutadas (más fuerte que statement coverage).", en: "White-box technique measuring the percentage of control flow branches executed (stronger than statement coverage)." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.3.2" },
  { term: "Prueba exploratoria / Exploratory testing", def: { es: "Técnica basada en experiencia donde el diseño y la ejecución de pruebas ocurren simultáneamente, sin scripts predefinidos.", en: "Experience-based technique where test design and execution happen simultaneously, without predefined scripts." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.4.2" },
  { term: "Predicción de errores / Error guessing", def: { es: "Técnica basada en experiencia donde el tester usa intuición y experiencia para anticipar tipos de errores comunes.", en: "Experience-based technique where the tester uses intuition and experience to anticipate common error types." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.4.1" },
  { term: "Desarrollo guiado por prueba de aceptación (ATDD) / Acceptance test-driven development", def: { es: "Acceptance Test-Driven Development: técnica donde los tests de aceptación se crean antes del desarrollo con participación de todo el equipo.", en: "Acceptance Test-Driven Development: technique where acceptance tests are created before development with full team participation." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.5.3" },
  { term: "Técnica de prueba / Test technique", def: { es: "Procedimiento sistemático usado en el análisis y diseño de la prueba para derivar condiciones de prueba, elementos de cobertura y casos de prueba; se clasifican en técnicas de caja negra, de caja blanca y basadas en la experiencia.", en: "Systematic procedure used during test analysis and design to derive test conditions, coverage items, and test cases; classified as black-box, white-box, and experience-based techniques." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.1" },
  { term: "Técnica de prueba de caja negra / Black-box test technique", def: { es: "Categoría de técnicas de diseño de casos de prueba, también llamada basada en especificación, que deriva los casos de prueba del comportamiento especificado del objeto de prueba sin considerar su estructura interna (p. ej. partición de equivalencia). Distinta de 'prueba de caja negra' (tipo de prueba, cap. 2): esta es la técnica de diseño, no el tipo de prueba.", en: "Category of test case design techniques, also known as specification-based, that derives test cases from the specified behavior of the test object without considering its internal structure (e.g., equivalence partitioning). Distinct from 'black-box testing' (test type, ch. 2): this is the design technique, not the test type." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.1" },
  { term: "Técnica de prueba de caja blanca / White-box test technique", def: { es: "Categoría de técnicas de diseño de casos de prueba, también llamada basada en la estructura, que deriva los casos de prueba del análisis de la estructura interna y el procesamiento del objeto de prueba (p. ej. cobertura de sentencia, cobertura de rama). Distinta de 'prueba de caja blanca' (tipo de prueba, cap. 2): esta es la técnica de diseño, no el tipo de prueba.", en: "Category of test case design techniques, also known as structure-based, that derives test cases from an analysis of the test object's internal structure and processing (e.g., statement coverage, branch coverage). Distinct from 'white-box testing' (test type, ch. 2): this is the design technique, not the test type." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.1" },
  { term: "Técnica de prueba basada en la experiencia / Experience-based test technique", def: { es: "Categoría de técnicas de diseño de casos de prueba que aprovecha el conocimiento y la experiencia del probador; detecta defectos que las técnicas de caja negra y caja blanca pueden pasar por alto, por lo que las complementa (p. ej. prueba exploratoria, predicción de errores).", en: "Category of test case design techniques that effectively uses the tester's knowledge and experience; it can detect defects missed by black-box and white-box techniques, making it complementary to them (e.g., exploratory testing, error guessing)." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.1" },
  ...
  { term: "Prueba basada en lista de comprobación / Checklist-based testing", def: { es: "Técnica basada en la experiencia en la que el probador diseña, implementa y ejecuta pruebas para cubrir las condiciones de una lista de comprobación construida a partir de la experiencia o del conocimiento de cómo falla el software.", en: "Experience-based technique in which the tester designs, implements, and executes tests to cover the conditions of a checklist built from experience or knowledge of how software fails." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.4.3" },
  { term: "Enfoque de prueba basado en la colaboración / Collaboration-based test approach", def: { es: "Enfoque de prueba que, a diferencia de las técnicas de caja negra, caja blanca y basadas en la experiencia, se centra también en la prevención de defectos mediante la colaboración y la comunicación (p. ej. redacción colaborativa de historias de usuario).", en: "Test approach that, unlike black-box, white-box, and experience-based techniques, also focuses on defect prevention through collaboration and communication (e.g., collaborative user story writing)." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.5" },
  { term: "Criterios de aceptación / Acceptance criteria", def: { es: "Condiciones que debe cumplir la implementación de una historia de usuario para ser aceptada por los interesados; se redactan en formato orientado a escenarios (Given/When/Then) o a reglas.", en: "Conditions that an implementation of a user story must meet to be accepted by stakeholders; written in a scenario-oriented (Given/When/Then) or rule-oriented format." }, chapter: "4", source: "Syllabus v4.0 keywords §4 · §4.5.2" },
  { term: "Plan de prueba / Test plan", def: { es: "Documento que describe el enfoque, recursos, alcance, criterios y actividades de testing para un proyecto.", en: "Document describing the testing approach, resources, scope, criteria and activities for a project." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.1.1" },
  { term: "Riesgo de producto / Product risk", def: { es: "Posibilidad de que el producto de software no cumpla con su función esperada o los requisitos de calidad.", en: "Possibility that the software product won't fulfill its expected function or quality requirements." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.2.2" },
  { term: "Riesgo de proyecto / Project risk", def: { es: "Posibilidad de que el proyecto no logre sus objetivos de alcance, tiempo o presupuesto.", en: "Possibility that the project won't achieve its scope, time or budget objectives." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.2.2" },
  { term: "Criterios de entrada / Entry criteria", def: { es: "Condiciones que deben cumplirse para iniciar una actividad de testing.", en: "Conditions that must be met to start a testing activity." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.1.3" },
  { term: "Criterios de salida / Exit criteria", def: { es: "Condiciones que deben cumplirse para completar una actividad de testing.", en: "Conditions that must be met to complete a testing activity." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.1.3" },
  { term: "Métricas de prueba / Test metrics", def: { es: "Medidas cuantitativas usadas para gestionar y controlar el proceso de testing (cobertura, densidad de defectos, etc.).", en: "Quantitative measures used to manage and control the test process (coverage, defect density, etc.)." }, chapter: "5", source: "Syllabus v4.0 §5.3.1" },
  { term: "Gestión de la configuración / Configuration management", def: { es: "Disciplina para controlar y registrar la evolución de los artefactos de software y testware a lo largo del proyecto.", en: "Discipline for controlling and recording the evolution of software and testware artifacts throughout the project." }, chapter: "5", source: "Syllabus v4.0 §5.4" },
  { term: "Severidad / Severity", def: { es: "Grado de impacto técnico que tiene un defecto sobre el sistema.", en: "Degree of technical impact a defect has on the system." }, chapter: "5", source: "Foundations of Software Testing (ISTQB Certification) — cap. 5.6.2, Informe de incidencias (severidad y prioridad de defectos)" },
  { term: "Prioridad / Priority", def: { es: "Urgencia con la que debe corregirse un defecto.", en: "Urgency with which a defect must be fixed." }, chapter: "5", source: "Foundations of Software Testing (ISTQB Certification) — cap. 5.6.2, Informe de incidencias (severidad y prioridad de defectos)" },
  { term: "Gestión de defectos / Defect management", def: { es: "Proceso de capturar, investigar, resolver y cerrar los defectos encontrados durante el testing.", en: "Process of capturing, investigating, resolving and closing defects found during testing." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.5" },
  { term: "Riesgo / Risk", def: { es: "Evento, peligro, amenaza o situación potencial cuya ocurrencia produce un efecto adverso; se caracteriza por su probabilidad de ocurrencia (risk likelihood) y su impacto (risk impact).", en: "A potential event, hazard, threat or situation whose occurrence has an adverse effect; characterized by its likelihood of occurrence and its impact." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.2.1" },
  { term: "Nivel de riesgo / Risk level", def: { es: "Medida del riesgo derivada de la combinación de su probabilidad y su impacto; cuanto mayor es el nivel de riesgo, más importante es su tratamiento.", en: "A measure of a risk, derived from the combination of its likelihood and its impact; the higher the risk level, the more important its treatment." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.2.1" },
  { term: "Gestión del riesgo / Risk management", def: { es: "Conjunto de actividades coordinadas para dirigir y controlar una organización con respecto al riesgo; en testing comprende el análisis del riesgo (identificación y evaluación) y el control del riesgo (mitigación y monitorización).", en: "The coordinated set of activities to direct and control an organization with regard to risk; in testing it comprises risk analysis (identification and assessment) and risk control (mitigation and monitoring)." }, chapter: "5", source: "Syllabus v4.0 keywords §5 · §5.2" },
