...
const GLOSSARY = [
  ...
  { term: "Causa raíz / Root cause", def: { es: "Razón fundamental por la que ocurre un problema. La eliminación de la causa raíz evita la recurrencia del defecto.", en: "Fundamental reason why a problem occurs. Removing the root cause prevents defect recurrence." }, chapter: "1", source: "Syllabus v4.0 keywords §1 · §1.2.4" },
